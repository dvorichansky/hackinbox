    ...
    $.fn.pickAColor = function (options) {
      ...
      var markupAfterInput = function () {
        var $markup = $("<div>").addClass("input-group-append"),
            $dropdownButton = $("<button type='button'>").addClass("btn btn-outline-secondary color-dropdown dropdown-toggle"),
      ...
      var methods = {
        ...
        initialize: function (index) {
          ...
          if (settings.showHexInput) {
            $thisParent.prepend('<div class="input-group-prepend"><span class="input-group-text">#</span></div>').append(markupAfterInput());
          } else {
